...
module ADC_SAR_v3_10_0 (
	...
	cy_clock_v1_0
		#(.id("c8a5125c-e9a5-4683-82ab-76b8744d7b98/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("535715625.003348"),
		  .is_direct(0),
		  .is_digital(0))
		theACLK
		 (.clock_out(Net_385),
	...
	cy_psoc3_pins_v1_10
		#(.id("c8a5125c-e9a5-4683-82ab-76b8744d7b98/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("12ce3d51-3a5d-491e-bc32-7a39f0ffc9ca/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__Pin6_5_net;
	wire [0:0] tmpFB_0__Pin6_5_net;
	wire [0:0] tmpIO_0__Pin6_5_net;
	wire [0:0] tmpINTERRUPT_0__Pin6_5_net;
	electrical [0:0] tmpSIOVREF__Pin6_5_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin6_5
		 (.oe(tmpOE__Pin6_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin6_5_net[0:0]}),
		  .analog({Net_11}),
		  .io({tmpIO_0__Pin6_5_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin6_5_net),
		  .interrupt({tmpINTERRUPT_0__Pin6_5_net[0:0]}),
		  .annotation({Net_2}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin6_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
