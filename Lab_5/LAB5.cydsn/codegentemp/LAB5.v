// ======================================================================
// LAB5.v generated from TopDesign.cysch
// 11/29/2021 at 20:44
...
// Sample_Hold_v1_40(Power=2, Sample_Clock_Edge=1, Sample_Mode=1, Vdda_Value=5, Vref_Type=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Sample_Hold_v1_40, CY_CONFIG_TITLE=Sample_Hold, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Sample_Hold, CY_INSTANCE_SHORT_NAME=Sample_Hold, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=40, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Sample_Hold, )
...
module CharLCD_v2_20_6 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ba2d8366-ff3a-438e-9adc-56ed4729542d/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    Sample_Hold_v1_40_1 Sample_Hold (
        .sclk(Net_699),
        .Vin(Net_2123),
        .Vout(Net_2095),
        .Vref(Net_19));
    ...
    assign Net_63 = ~Net_708;


    assign Net_707 = Net_1523 & Net_709;


    assign Net_699 = Net_721 | Net_740;
    ...
    // -- DFF Start --
    reg  cydff_1;
    always @(posedge Net_712)
    begin
        cydff_1 <= ((Net_721 | Net_740)& ~Net_63);
    end
    assign Net_721 = cydff_1;
    // -- DFF End --
	...
	wire [0:0] tmpOE__Pin3_5_net;
	wire [0:0] tmpFB_0__Pin3_5_net;
	wire [0:0] tmpIO_0__Pin3_5_net;
	wire [0:0] tmpINTERRUPT_0__Pin3_5_net;
	electrical [0:0] tmpSIOVREF__Pin3_5_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin3_5
		 (.oe(tmpOE__Pin3_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin3_5_net[0:0]}),
		  .analog({Net_2123}),
		  .io({tmpIO_0__Pin3_5_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin3_5_net),
		  .interrupt({tmpINTERRUPT_0__Pin3_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin3_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    assign Net_2091 = 1'h0;
	...
	cy_psoc3_pins_v1_10
		#(.id("3d7a5815-0a8c-4c0c-8582-15a477c06642"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin5_1_net;
	wire [0:0] tmpFB_0__Pin5_1_net;
	wire [0:0] tmpIO_0__Pin5_1_net;
	wire [0:0] tmpINTERRUPT_0__Pin5_1_net;
	electrical [0:0] tmpSIOVREF__Pin5_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin5_1
		 (.oe(tmpOE__Pin5_1_net),
		  .y({Net_699}),
		  .fb({tmpFB_0__Pin5_1_net[0:0]}),
		  .io({tmpIO_0__Pin5_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin5_1_net),
		  .interrupt({tmpINTERRUPT_0__Pin5_1_net[0:0]}),
		  .annotation({Net_695}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin5_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin12_5_net;
	wire [0:0] tmpFB_0__Pin12_5_net;
	wire [0:0] tmpIO_0__Pin12_5_net;
	wire [0:0] tmpINTERRUPT_0__Pin12_5_net;
	electrical [0:0] tmpSIOVREF__Pin12_5_net;

	cy_psoc3_pins_v1_10
		#(.id("64f8aff4-ac92-4448-8807-562de95714a2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin12_5
		 (.oe(tmpOE__Pin12_5_net),
		  .y({Net_707}),
		  .fb({tmpFB_0__Pin12_5_net[0:0]}),
		  .io({tmpIO_0__Pin12_5_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin12_5_net),
		  .interrupt({tmpINTERRUPT_0__Pin12_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin12_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin1_4_net;
	wire [0:0] tmpFB_0__Pin1_4_net;
	wire [0:0] tmpIO_0__Pin1_4_net;
	wire [0:0] tmpINTERRUPT_0__Pin1_4_net;
	electrical [0:0] tmpSIOVREF__Pin1_4_net;

	cy_psoc3_pins_v1_10
		#(.id("e1cede83-2025-4c08-807a-20810edf911d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin1_4
		 (.oe(tmpOE__Pin1_4_net),
		  .y({Net_708}),
		  .fb({tmpFB_0__Pin1_4_net[0:0]}),
		  .io({tmpIO_0__Pin1_4_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin1_4_net),
		  .interrupt({tmpINTERRUPT_0__Pin1_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin1_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin12_6_net;
	wire [0:0] tmpFB_0__Pin12_6_net;
	wire [0:0] tmpIO_0__Pin12_6_net;
	wire [0:0] tmpINTERRUPT_0__Pin12_6_net;
	electrical [0:0] tmpSIOVREF__Pin12_6_net;

	cy_psoc3_pins_v1_10
		#(.id("777c3a54-d1fa-4858-b9e3-99f0d265a725"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin12_6
		 (.oe(tmpOE__Pin12_6_net),
		  .y({Net_740}),
		  .fb({tmpFB_0__Pin12_6_net[0:0]}),
		  .io({tmpIO_0__Pin12_6_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin12_6_net),
		  .interrupt({tmpINTERRUPT_0__Pin12_6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin12_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin2_7_net;
	wire [0:0] tmpFB_0__Pin2_7_net;
	wire [0:0] tmpIO_0__Pin2_7_net;
	wire [0:0] tmpINTERRUPT_0__Pin2_7_net;
	electrical [0:0] tmpSIOVREF__Pin2_7_net;

	cy_psoc3_pins_v1_10
		#(.id("368d9807-f73d-468e-a4fd-8e0044fe6a89"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin2_7
		 (.oe(tmpOE__Pin2_7_net),
		  .y({Net_721}),
		  .fb({tmpFB_0__Pin2_7_net[0:0]}),
		  .io({tmpIO_0__Pin2_7_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin2_7_net),
		  .interrupt({tmpINTERRUPT_0__Pin2_7_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin2_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin3_0_net;
	wire [0:0] tmpFB_0__Pin3_0_net;
	wire [0:0] tmpIO_0__Pin3_0_net;
	wire [0:0] tmpINTERRUPT_0__Pin3_0_net;
	electrical [0:0] tmpSIOVREF__Pin3_0_net;

	cy_psoc3_pins_v1_10
		#(.id("001c273b-ecfc-4b11-84fc-f2e5afc41253"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin3_0
		 (.oe(tmpOE__Pin3_0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin3_0_net[0:0]}),
		  .analog({Net_689}),
		  .io({tmpIO_0__Pin3_0_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin3_0_net),
		  .interrupt({tmpINTERRUPT_0__Pin3_0_net[0:0]}),
		  .annotation({Net_13}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin3_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("77ef81fd-edac-4740-8994-9825016a75d3"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
