// ======================================================================
// Lab -02.v generated from TopDesign.cysch
// 10/11/2021 at 18:32
...
module CharLCD_v2_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("29747d7b-996a-453f-afd1-b40a33c11ce3/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("e6f1c1c1-22b3-460c-ac7a-255b0bbd1736"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("edc3403c-7a0c-403b-8303-fdcdc079076b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__P3_1_net;
	wire [0:0] tmpFB_0__P3_1_net;
	wire [0:0] tmpIO_0__P3_1_net;
	wire [0:0] tmpINTERRUPT_0__P3_1_net;
	electrical [0:0] tmpSIOVREF__P3_1_net;

	cy_psoc3_pins_v1_10
		#(.id("310ecbf5-dbcf-4aeb-9261-eae5e112e69c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__P3_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("925fdb9c-6c53-4395-9dd5-e4b395528619"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7264c98b-8061-4b21-a30a-7b4d97f8a966"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
