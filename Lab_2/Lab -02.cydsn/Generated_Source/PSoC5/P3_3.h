...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the P3_3_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(P3_3__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in P3_3_SetInterruptMode() function.
     *  @{
     */
        #define P3_3_INTR_NONE      (uint16)(0x0000u)
        #define P3_3_INTR_RISING    (uint16)(0x0001u)
        #define P3_3_INTR_FALLING   (uint16)(0x0002u)
        #define P3_3_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define P3_3_INTR_MASK      (0x01u) 
#endif /* (P3_3__INTSTAT) */
...
/* SIO registers */
#if defined(P3_3__SIO_CFG)
    #define P3_3_SIO_HYST_EN        (* (reg8 *) P3_3__SIO_HYST_EN)
    #define P3_3_SIO_REG_HIFREQ     (* (reg8 *) P3_3__SIO_REG_HIFREQ)
    #define P3_3_SIO_CFG            (* (reg8 *) P3_3__SIO_CFG)
    #define P3_3_SIO_DIFF           (* (reg8 *) P3_3__SIO_DIFF)
#endif /* (P3_3__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define P3_3_0_INTTYPE_REG 		(* (reg8 *) P3_3__0__INTTYPE)
#endif /* (P3_3__INTSTAT) */
