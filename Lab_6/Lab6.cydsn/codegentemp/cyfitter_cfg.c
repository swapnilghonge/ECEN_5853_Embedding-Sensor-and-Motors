...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000084u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT2_AMUX, 0x0201u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT3_AMUX, 0x0908u);
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_OPAMP0_MX, 0x01040104u);
