...
*
* \funcusage
*  \snippet P3_7_SUT.c usage_P3_7_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet P3_7_SUT.c usage_P3_7_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet P3_7_SUT.c usage_P3_7_Read  
*******************************************************************************/
...
* preferred P3_7_Read() API because the 
* P3_7_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet P3_7_SUT.c usage_P3_7_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: P3_7_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use P3_7_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - P3_7_0_INTR       (First pin in the list)
    *  - P3_7_1_INTR       (Second pin in the list)
    *  - ...
    *  - P3_7_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet P3_7_SUT.c usage_P3_7_SetInterruptMode
    *******************************************************************************/
    void P3_7_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & P3_7_0_INTR) != 0u) 
		{ 
			 P3_7_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet P3_7_SUT.c usage_P3_7_ClearInterrupt
    *******************************************************************************/
