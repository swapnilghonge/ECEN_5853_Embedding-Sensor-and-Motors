...
// OpAmp_v1_90(Mode=1, Power=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONFIG_TITLE=Opamp, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp, CY_INSTANCE_SHORT_NAME=Opamp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Opamp, )
...
module ADC_DelSig_v3_30_3 (
	...
	cy_clock_v1_0
		#(.id("09c6a2da-eead-4f43-beaa-9c3ab044948c/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("09c6a2da-eead-4f43-beaa-9c3ab044948c/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1564945226.91706"),
		  .is_direct(0),
		  .is_digital(0))
		theACLK
		 (.clock_out(Net_250));
...
module CharLCD_v2_20_5 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("0440b0f2-66f5-441d-b0f9-efa5d2de773a/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    defparam VDAC.Initial_Value = 75;
	...
	cy_psoc3_pins_v1_10
		#(.id("77cf30a7-493a-44d5-a285-6c9dcabc9aba"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("de45a60f-d147-4f80-af5b-6e35e86d1617"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin0_1_net;
	wire [0:0] tmpFB_0__Pin0_1_net;
	wire [0:0] tmpIO_0__Pin0_1_net;
	wire [0:0] tmpINTERRUPT_0__Pin0_1_net;
	electrical [0:0] tmpSIOVREF__Pin0_1_net;

	cy_psoc3_pins_v1_10
		#(.id("e38cc149-5953-4a91-ae3c-e86586329bf4"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin0_1
		 (.oe(tmpOE__Pin0_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin0_1_net[0:0]}),
		  .analog({Net_44}),
		  .io({tmpIO_0__Pin0_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin0_1_net),
		  .interrupt({tmpINTERRUPT_0__Pin0_1_net[0:0]}),
		  .annotation({Net_8}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin0_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin3_7_net;
	wire [0:0] tmpFB_0__Pin3_7_net;
	wire [0:0] tmpIO_0__Pin3_7_net;
	wire [0:0] tmpINTERRUPT_0__Pin3_7_net;
	electrical [0:0] tmpSIOVREF__Pin3_7_net;

	cy_psoc3_pins_v1_10
		#(.id("28bcfc55-12a3-415b-9d0b-7fda92724304"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin3_7
		 (.oe(tmpOE__Pin3_7_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin3_7_net[0:0]}),
		  .analog({Net_16}),
		  .io({tmpIO_0__Pin3_7_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin3_7_net),
		  .interrupt({tmpINTERRUPT_0__Pin3_7_net[0:0]}),
		  .annotation({Net_72}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin3_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    USBFS_v3_20_6 USBUART (
        .sof(Net_67),
        .vbusdet(1'b0));
