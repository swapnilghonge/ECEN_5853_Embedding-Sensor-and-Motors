...
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000074u)

/* IOPINS0_3 Address: CYREG_PRT3_DM0 Size (bytes): 8 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x4800007Cu)

/* IOPINS0_5 Address: CYREG_PRT5_DM0 Size (bytes): 8 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x48000084u)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x4800008Cu)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT5_AG, 0x08u);
...
uint8 CYXDATA * const CYCODE AMux_1_CYAMUXSIDE_A__addrTable[4] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux_1_CYAMUXSIDE_A__maskTable[4] = {
	0x04u, 0x40u, 
	0x02u, 0x01u, 
};
...
uint8 CYXDATA * const CYCODE AMux_1_CYAMUXSIDE_B__addrTable[4] = {
	(uint8 CYXDATA *)CYREG_PRT0_AG, (uint8 CYXDATA *)CYREG_DAC2_SW4, 
