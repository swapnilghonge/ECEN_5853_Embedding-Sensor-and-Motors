// ======================================================================
// Assignment_1.v generated from TopDesign.cysch
// 09/23/2021 at 15:19
...
module ADC_DelSig_v3_30_0 (
	...
	cy_clock_v1_0
		#(.id("7c8b1239-0a02-4323-a73b-667ee2df42e8/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("7c8b1239-0a02-4323-a73b-667ee2df42e8/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1562500000"),
		  .is_direct(0),
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("3bc4a60a-4034-4de4-ab15-2a0b757bf3a0/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    cy_annotation_universal_v1_0 PWR_5_volts (
        .connect({
            Net_16
        })
    );
    defparam PWR_5_volts.comp_name = "Power_v1_0";
    defparam PWR_5_volts.port_names = "T1";
    defparam PWR_5_volts.width = 1;

	wire [0:0] tmpOE__P5_0_net;
	wire [0:0] tmpFB_0__P5_0_net;
	wire [0:0] tmpIO_0__P5_0_net;
	wire [0:0] tmpINTERRUPT_0__P5_0_net;
	electrical [0:0] tmpSIOVREF__P5_0_net;
	...
	cy_psoc3_pins_v1_10
		...
		P5_0
		 (.oe(tmpOE__P5_0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__P5_0_net[0:0]}),
		  .analog({Net_56}),
		  .io({tmpIO_0__P5_0_net[0:0]}),
		  .siovref(tmpSIOVREF__P5_0_net),
		  .interrupt({tmpINTERRUPT_0__P5_0_net[0:0]}),
		  .annotation({Net_14}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__P5_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__P5_1_net;
	wire [0:0] tmpFB_0__P5_1_net;
	wire [0:0] tmpIO_0__P5_1_net;
	wire [0:0] tmpINTERRUPT_0__P5_1_net;
	electrical [0:0] tmpSIOVREF__P5_1_net;

	cy_psoc3_pins_v1_10
		#(.id("ec2d1cd7-7967-44dc-bf84-76a16df31595"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		P5_1
		 (.oe(tmpOE__P5_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__P5_1_net[0:0]}),
		  .analog({Net_27}),
		  .io({tmpIO_0__P5_1_net[0:0]}),
		  .siovref(tmpSIOVREF__P5_1_net),
		  .interrupt({tmpINTERRUPT_0__P5_1_net[0:0]}),
		  .annotation({Net_11}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__P5_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("7936041c-1bcf-41c9-83a0-0521582a255c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a1df56c9-073e-448a-b47b-0ac0c6f94bd2"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d8a61b0f-f0a2-43dd-8405-b3bf808218d4"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin1_7_net;
	wire [0:0] tmpFB_0__Pin1_7_net;
	wire [0:0] tmpIO_0__Pin1_7_net;
	wire [0:0] tmpINTERRUPT_0__Pin1_7_net;
	electrical [0:0] tmpSIOVREF__Pin1_7_net;

	cy_psoc3_pins_v1_10
		#(.id("620e66ac-cab4-44c6-8176-71d21dd51fe2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin1_7
		 (.oe(tmpOE__Pin1_7_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin1_7_net[0:0]}),
		  .io({tmpIO_0__Pin1_7_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin1_7_net),
		  .interrupt({tmpINTERRUPT_0__Pin1_7_net[0:0]}),
		  .annotation({Net_77}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin1_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin3_1_net;
	wire [0:0] tmpFB_0__Pin3_1_net;
	wire [0:0] tmpIO_0__Pin3_1_net;
	wire [0:0] tmpINTERRUPT_0__Pin3_1_net;
	electrical [0:0] tmpSIOVREF__Pin3_1_net;

	cy_psoc3_pins_v1_10
		#(.id("fbb0f486-c710-4e66-9ecc-e37a96bfdfe3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin3_1
		 (.oe(tmpOE__Pin3_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin3_1_net[0:0]}),
		  .io({tmpIO_0__Pin3_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin3_1_net),
		  .interrupt({tmpINTERRUPT_0__Pin3_1_net[0:0]}),
		  .annotation({Net_75}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin3_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
