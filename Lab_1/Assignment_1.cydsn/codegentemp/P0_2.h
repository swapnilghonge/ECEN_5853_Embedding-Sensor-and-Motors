...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the P0_2_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(P0_2__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in P0_2_SetInterruptMode() function.
     *  @{
     */
        #define P0_2_INTR_NONE      (uint16)(0x0000u)
        #define P0_2_INTR_RISING    (uint16)(0x0001u)
        #define P0_2_INTR_FALLING   (uint16)(0x0002u)
        #define P0_2_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define P0_2_INTR_MASK      (0x01u) 
#endif /* (P0_2__INTSTAT) */
...
/* SIO registers */
#if defined(P0_2__SIO_CFG)
    #define P0_2_SIO_HYST_EN        (* (reg8 *) P0_2__SIO_HYST_EN)
    #define P0_2_SIO_REG_HIFREQ     (* (reg8 *) P0_2__SIO_REG_HIFREQ)
    #define P0_2_SIO_CFG            (* (reg8 *) P0_2__SIO_CFG)
    #define P0_2_SIO_DIFF           (* (reg8 *) P0_2__SIO_DIFF)
#endif /* (P0_2__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define P0_2_0_INTTYPE_REG 		(* (reg8 *) P0_2__0__INTTYPE)
#endif /* (P0_2__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_P0_2_H */
